...
<div dir="rtl" style="
  ...
  line-height:1.9;
  color:#E5E7EB;">
  <h4>نشرح الجزء سريعا</h4>
  <ul style="margin:0; padding-right:18px;">
    <h5>jr $ra = jump to return address</h5>
    <li>روح لعنوان الرجوع وابدأ اشتغل من عنده</li>
    <h5>li $v0 0x7B</h5>
    <li>register v0 هي المسؤولة عن الإرجاع زي EAX</li>
    <li>فهنا هيرجع 123= 0x7B</li>
    <h5>طب ازاي هيـjump الأول ولسة فيه تعليمة بعدها؟ </h5>
    <h5>دا هنشوفه في الجزئية الجاية ودي نفس المخرجات من الgcc بس مكتوبة بالأررقام <h5>
  </ul>
</div>
